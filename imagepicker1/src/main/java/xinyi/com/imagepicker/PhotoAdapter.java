...
public class PhotoAdapter  extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        moreSelectItemHolder.iconImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (t.getPath()==null||t.getPath().equals("")){
                    ...
                    Intent intent1 = new Intent( moreSelectItemHolder.iconImageView.getContext() , ImageGridActivity.class);

                    ((Activity)moreSelectItemHolder.iconImageView.getContext()).startActivityForResult(intent1, IMAGE_PICKER);
                }else {
                    //查看大图
    ...
    public void  performTakenPhoto(Context context){
